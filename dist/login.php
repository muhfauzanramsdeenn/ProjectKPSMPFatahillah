...
<html lang="en">
    <head>
        ...
        <style>
            .bg-dark {
                background-color: #343a40 !important; /* Ganti dengan warna atau gambar yang diinginkan */
                background-image: url('../src/img/Background.jpeg') !important; /* Jika ingin menggunakan gambar */
                background-size: cover !important; /* Agar gambar memenuhi seluruh background */
                background-position: center !important; /* Agar gambar berada di tengah */
            }
                            ...
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5 card-transparent">
                                     ...
                                     <div class="card-body">
                                        ...
                                        <h3 class="text-center font-weight-bold my-4 text-white"><?php echo ucwords($data['nama_aplikasi']);?></h3>
                                    ...
                                    <form action="<?php echo $_SERVER["PHP_SELF"];?>" method="post">
                                        <br>
                                            <div class="form-group ">
                                                <label class="small mb-1 text-white"></label>
                                                <input class="form-control py-4 text-center"  name="username" type="text" placeholder="Masukan Username" />
                                            </div>
                                            <div class="form-group ">
                                                <label class="small mb-1 text-white"></label>
                                                <input class="form-control py-4 text-center" name="password" type="password" placeholder="Masukan Password" />
                                            </div>
                                    ...
                                    <div class="card-footer text-center ">
                                            <a href="daftar.php" class="mb-1 text-white">Belum mempunyai akun? Daftar sekarang!</a></div>
                                             <a href="index1.php" class="mb-1 text-white">Kembali Ke Beranda</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div id="layoutAuthentication_footer">
                    <div class="container-fluid">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted text-white">Copyright &copy; <?php echo $data['nama_aplikasi'];?> <?php echo date('Y');?></div>
                        </div>
                    </div>
                </footer>
            </div>
