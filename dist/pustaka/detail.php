        ...
        <div class="col-sm-6">
            <table class="table">
                <tbody>
                    ...
                    <tr>
                    <td>Sinopsis</td>
                        <td width="78%">: <?php echo $data['sinopsis'];?></td>
                        </tr>
                    <?php if ($data['stok']>=1): ?>
                    <tr>
                        <td colspan="2">  
                            <?php if ($_SESSION['level']=='Anggota' or $_SESSION['level']=='anggota'): ?>
                            <a href="index.php?page=keranjang&kode_pustaka=<?php echo $data['kode_pustaka']; ?>&aksi=pilih_pustaka"  class="btn btn-dark btn-block">Pinjam</a>
                            <?php endif; ?>
                        </td>
                    </tr>
                    <?php endif; ?>
